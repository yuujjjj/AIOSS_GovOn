        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800/30">
              ...
              <Link href="/main" className="inline-flex px-6 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors">
                새 분석 생성
              </Link>
            </div>
            ...
            <div className="p-6 bg-zinc-50 dark:bg-zinc-800/50 rounded-xl border border-zinc-200 dark:border-zinc-700/50">
              ...
              <Link href="/main" className="inline-flex px-6 py-2 border border-zinc-300 dark:border-zinc-600 rounded-lg font-medium hover:bg-zinc-100 dark:hover:bg-zinc-700 transition-colors">
                기록 보기
              </Link>
            </div>
          </div>
