...
| ADR | 제목 | 상태 | 핵심 결정 |
|-----|------|------|-----------|
| [ADR-001](../../../../docs/adr/ADR-001-exaone-model-selection.md) | EXAONE-Deep-7.8B 모델 선정 | Accepted | 한국어 특화 + Apache 2.0 + 추론 체인 내장 |
| [ADR-002](../../../../docs/adr/ADR-002-awq-quantization.md) | AWQ W4A16g128 양자화 방식 선정 | Accepted | 15.6GB에서 4.94GB로 68.3% 감소, vLLM 네이티브 지원 |
| [ADR-003](../../../../docs/adr/ADR-003-vllm-serving.md) | vLLM 추론 서빙 엔진 선정 | Accepted | PagedAttention + AsyncLLMEngine + AWQ 네이티브 로드 |
| [ADR-004](../../../../docs/adr/ADR-004-faiss-vector-search.md) | FAISS 기반 벡터 검색 엔진 선정 | Accepted | 폐쇄망 적합, pip 설치만으로 사용, CPU 전용 동작 |
...
[:octicons-arrow-right-24: 전문 보기](../../../../docs/adr/ADR-001-exaone-model-selection.md)
...
[:octicons-arrow-right-24: 전문 보기](../../../../docs/adr/ADR-002-awq-quantization.md)
...
[:octicons-arrow-right-24: 전문 보기](../../../../docs/adr/ADR-003-vllm-serving.md)
...
[:octicons-arrow-right-24: 전문 보기](../../../../docs/adr/ADR-004-faiss-vector-search.md)
